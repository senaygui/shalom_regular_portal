...
ActiveRecord::Schema[7.0].define(version: 2025_04_04_091132) do
  ...
  add_foreign_key "assessments", "assessment_plans"
  add_foreign_key "assessments", "course_registrations"
  add_foreign_key "assessments", "student_grades"
