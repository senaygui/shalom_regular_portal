...
class AttendancePdfGenerator
  ...
  def add_header(pdf)
    # Logo
    pdf.image "app/assets/images/logo.jpg", at: [pdf.bounds.left + 10, pdf.bounds.top - 10]

    # Title
    pdf.text_box "Shalom College Portal Attendance Sheet", at: [0, pdf.bounds.top - 30], width: pdf.bounds.width, align: :center, size: 30
  end
